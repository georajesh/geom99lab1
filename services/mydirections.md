...
```
[https://YourDirectionsApiURLGoesHere](https://maps.googleapis.com/maps/api/directions/json?origin=Toronto&destination=Fleming+College+Frost+Campus&mode=bicycling&key=AIzaSyCM-WWHYHIKY-do4kquMy9Z4wQaQx51AuE)
```
